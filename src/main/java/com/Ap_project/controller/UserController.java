...
public class UserController {
    ...
    public void createUser(String id, String email, String firstName, String lastName, String passWord, Date joinDate, String country, String city, String profession) throws SQLException {
        User user = new User(id, email , firstName , lastName , passWord , joinDate , country , city , profession);
        if (isUserExists(id))
    ...
    public void updateUser(String id, String email, String firstName, String lastName, String passWord, Date joinDate, String country, String city, String profession) throws SQLException {
        User user = new User(id, email, firstName, lastName, passWord, joinDate, country, city, profession);
        userDAO.updateUser(user);
    }
